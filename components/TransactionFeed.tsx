...
import { ArrowUp, ArrowDown, Zap, Pause } from 'lucide-react';

interface TransactionFeedProps {
  transactions: Transaction[];
  networkName?: string; // New Prop
}
  ...
  return (
    ...
    >
      ...
      <div className="mb-4 flex justify-between items-center">
        <div>
            <div className="text-[10px] uppercase tracking-widest font-bold text-gray-500 mb-1 flex items-center gap-1 transition-colors duration-500">
      ...
      <div className="flex flex-col gap-2 relative mask-linear-fade">
